...
export const stateDistricts = {
  ...
  'Arunachal Pradesh': [
    ...
    'Pakke Kessang', 'Papum Pare', 'Shi Yomi', 'Tawang', 'Tirap', 
  ...
  'Mizoram': [
    ...
    'Saiha', 'Serchhip', 'Khawzawl', 'Saitual', 'Hnahthial'
  ],
  'Nagaland': [
...
export const majorCities = {
  'Andhra Pradesh': [
    ...
    'Kakinada', 'Kadapa', 'Anantapur', 'Eluru', 'Ongole', 'Nandyal', 'Machilipatnam'
  ],
  'Arunachal Pradesh': [
    'Itanagar', 'Naharlagun', 'Pasighat', 'Tawang', 'Ziro', 'Bomdila', 'Aalo', 
    'Tezu', 'Namsai', 'Changlang', 'Roing', 'Khonsa', 'Yingkiong'
  ],
  'Assam': [
    'Guwahati', 'Silchar', 'Dibrugarh', 'Jorhat', 'Nagaon', 'Tinsukia', 'Tezpur', 
    'Karimganj', 'Sivasagar', 'Goalpara', 'Diphu', 'North Lakhimpur', 'Dhubri', 'Bongaigaon'
  ],
  'Bihar': [
  ...
  'Chhattisgarh': [
    ...
    'Raigarh', 'Ambikapur', 'Mahasamund', 'Dhamtari', 'Chirmiri', 'Dongargarh'
  ],
  'Goa': [
    'Panaji', 'Margao', 'Vasco da Gama', 'Mapusa', 'Ponda', 'Bicholim', 
    'Curchorem', 'Cuncolim', 'Canacona', 'Pernem', 'Valpoi', 'Sanguem'
  ],
  'Gujarat': [
    'Ahmedabad', 'Surat', 'Vadodara', 'Rajkot', 'Bhavnagar', 'Jamnagar', 'Gandhinagar', 
    'Junagadh', 'Anand', 'Navsari', 'Morbi', 'Nadiad', 'Surendranagar', 'Gandhidham', 
    'Bharuch', 'Porbandar', 'Palanpur', 'Valsad', 'Veraval', 'Godhra', 'Patan'
  ],
  'Haryana': [
    'Faridabad', 'Gurugram', 'Panipat', 'Ambala', 'Yamunanagar', 'Rohtak', 'Hisar', 
    'Karnal', 'Sonipat', 'Panchkula', 'Kurukshetra', 'Sirsa', 'Bhiwani', 'Bahadurgarh', 
    'Jind', 'Kaithal', 'Rewari', 'Palwal'
  ],
  'Himachal Pradesh': [
    'Shimla', 'Dharamshala', 'Mandi', 'Solan', 'Nahan', 'Sundarnagar', 'Paonta Sahib', 
    'Chamba', 'Kullu', 'Hamirpur', 'Una', 'Bilaspur', 'Nurpur', 'Palampur'
  ],
  'Jharkhand': [
    'Ranchi', 'Jamshedpur', 'Dhanbad', 'Bokaro Steel City', 'Hazaribagh', 'Deoghar', 
    'Giridih', 'Ramgarh', 'Phusro', 'Dumka', 'Chirkunda', 'Medininagar', 'Chaibasa'
  ],
  'Karnataka': [
    'Bengaluru', 'Mysuru', 'Hubballi-Dharwad', 'Mangaluru', 'Belagavi', 'Kalaburagi', 
    'Ballari', 'Vijayapura', 'Shivamogga', 'Tumakuru', 'Davanagere', 'Hassan', 
    'Udupi', 'Gadag', 'Kolar', 'Mandya', 'Chikkamagaluru', 'Chitradurga'
  ],
  'Kerala': [
    'Thiruvananthapuram', 'Kochi', 'Kozhikode', 'Thrissur', 'Kollam', 'Palakkad', 
    'Alappuzha', 'Kannur', 'Kottayam', 'Malappuram', 'Manjeri', 'Kasaragod', 
    'Kayamkulam', 'Nedumangad', 'Neyyattinkara', 'Pathanamthitta'
  ],
  'Madhya Pradesh': [
  ...
  'Maharashtra': [
    'Mumbai', 'Pune', 'Nagpur', 'Thane', 'Nashik', 'Aurangabad', 'Solapur', 'Kalyan-Dombivli', 
    'Vasai-Virar', 'Chhatrapati Sambhajinagar', 'Navi Mumbai', 'Kolhapur', 'Sangli', 
    'Jalgaon', 'Akola', 'Latur', 'Ahmednagar', 'Dhule', 'Nanded', 'Amravati',
    'Chandrapur', 'Parbhani', 'Jalna', 'Bhiwandi', 'Ulhasnagar', 'Panvel'
  ],
  'Manipur': [
    'Imphal', 'Thoubal', 'Bishnupur', 'Ukhrul', 'Senapati', 'Churachandpur', 
    'Kakching', 'Moreh', 'Jiribam', 'Mayang Imphal', 'Nambol', 'Lilong'
  ],
  'Meghalaya': [
    'Shillong', 'Tura', 'Jowai', 'Baghmara', 'Resubelpara', 'Nongstoin', 
    'Williamnagar', 'Nongpoh', 'Mairang', 'Cherrapunji', 'Mawlai'
  ],
  'Mizoram': [
  ...
  'Odisha': [
    ...
    'Balasore', 'Bhadrak', 'Baripada', 'Jharsuguda', 'Angul', 'Bargarh', 
    'Paradip', 'Jajpur', 'Jeypore', 'Balangir'
  ],
  'Punjab': [
  ...
  'Uttarakhand': [
    ...
    'Pithoragarh', 'Ramnagar', 'Khatima', 'Manglaur', 'Nainital', 'Mussoorie', 'Jaspur', 
    'Kotdwara', 'Almora', 'Tehri', 'Chamoli', 'Bageshwar', 'Champawat'
  ],
  'West Bengal': [
    'Kolkata', 'Asansol', 'Siliguri', 'Durgapur', 'Bardhaman', 'Malda', 'Baharampur', 
    'Habra', 'Jalpaiguri', 'Kharagpur', 'Shantipur', 'Darjeeling', 'Alipurduar', 
    'Krishna Nagar', 'Balurghat', 'Medinipur', 'Cooch Behar', 'Bankura', 'Purulia'
  ],
  'Andaman and Nicobar Islands': [
    'Port Blair', 'Havelock Island', 'Neil Island', 'Mayabunder', 'Car Nicobar', 
    'Little Andaman', 'Diglipur', 'Rangat', 'Bamboo Flat', 'Campbell Bay'
  ],
  'Chandigarh': ['Chandigarh'],
  'Dadra and Nagar Haveli and Daman and Diu': [
    'Silvassa', 'Daman', 'Diu', 'Dadra', 'Nagar Haveli', 'Amli', 'Vapi'
  ],
  'Delhi': [
    'New Delhi', 'Delhi Cantonment', 'Narela', 'Najafgarh', 'Dwarka', 'Rohini', 
    'Pitampura', 'Connaught Place', 'Karol Bagh', 'Lajpat Nagar', 'Greater Kailash', 
    'Chandni Chowk', 'Paharganj', 'Saket', 'Hauz Khas', 'Janakpuri'
  ],
  'Jammu and Kashmir': [
    'Srinagar', 'Jammu', 'Anantnag', 'Baramulla', 'Kathua', 'Sopore', 'Udhampur', 
    'Kupwara', 'Pulwama', 'Poonch', 'Rajouri', 'Handwara', 'Budgam', 'Ganderbal', 
    'Bandipore', 'Ramban', 'Reasi'
  ],
  'Ladakh': ['Leh', 'Kargil', 'Nubra', 'Zanskar', 'Drass'],
  'Lakshadweep': ['Kavaratti', 'Agatti', 'Andrott', 'Minicoy', 'Kalpeni', 'Amini'],
  'Puducherry': ['Puducherry', 'Karaikal', 'Yanam', 'Mahe', 'Ozhukarai']
};

// A comprehensive mapping of states to their districts and major cities
